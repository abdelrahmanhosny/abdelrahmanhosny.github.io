...
The attempt is to implement the following scenario. [Click here](/assets/images/posts/failure-story-docker-branching/Dockerfile-branching.svg){:target="_blank"} to open the image in a new tab and Zoom in.

![](/assets/images/posts/failure-story-docker-branching/Dockerfile-branching.svg)
