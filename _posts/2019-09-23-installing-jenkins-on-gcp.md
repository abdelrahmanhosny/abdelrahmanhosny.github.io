...
![](/assets/images/posts/jenkins-gcp/jenkins-gcp-1.png)
...
![](/assets/images/posts/jenkins-gcp/jenkins-gcp-2.png)

**STEP 3:** Select Debian GNU/Linux 9 (stretch).

![](/assets/images/posts/jenkins-gcp/jenkins-gcp-3.png)

**STEP 4:** Configure network access by choosing *allow defaul access*. Also, make sure to allow HTTP and HTTPS traffic.

![](/assets/images/posts/jenkins-gcp/jenkins-gcp-4.png)

**STEP 5:** Click Create

![](/assets/images/posts/jenkins-gcp/jenkins-gcp-5.png)

**STEP 6:** Once the VM is created, `ssh` to the machine from the browser by selecting from the menu *open in a browser window*.

![](/assets/images/posts/jenkins-gcp/jenkins-gcp-6.png)

**STEP 7:** You are in!

![](/assets/images/posts/jenkins-gcp/jenkins-gcp-7.png)
